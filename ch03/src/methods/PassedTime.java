...
public class PassedTime {
	...
	public static void main(String[] args) {
		Calendar theDay = Calendar.getInstance(); // 시작일 객체
		Calendar today = Calendar.getInstance(); // 오늘 객체
...
//		
	...
	public static void datePrint(Calendar date) {
		String startDay = date.get(Calendar.YEAR) + "년 " + 
				date.get(Calendar.MONTH) + " 월 " + date.get(Calendar.DATE) + "일";
//		return strDate; // 날짜 문자열을 반환
	}
